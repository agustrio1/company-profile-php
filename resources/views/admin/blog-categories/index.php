...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-heading">Manajemen Kategori Blog</h1>
            <p class="text-sm text-body mt-1">Kelola kategori untuk mengorganisir blog</p>
        </div>
        <a href="<?= url('admin/blog-categories/create') ?>" class="inline-flex items-center px-4 py-2.5 text-sm font-medium text-white bg-brand hover:bg-brand-strong focus:outline-none focus:ring-4 focus:ring-brand-medium rounded-base transition-colors">
    ...
    <div class="bg-neutral-primary-soft border border-default rounded-base p-4">
        <div class="relative">
            ...
            <input 
                ...
                hx-get="<?= url('admin/blog-categories/table') ?>"
    ...
    <div id="categories-table" 
         hx-get="<?= url('admin/blog-categories/table') ?>"
         hx-trigger="load, categoryDeleted from:body">
        <!-- Loading indicator -->
