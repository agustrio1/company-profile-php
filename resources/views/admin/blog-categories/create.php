...
<div class="max-w-3xl">
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-body mb-2">
            ...
            <span class="text-heading">Tambah Kategori</span>
        </div>
        <h1 class="text-2xl font-bold text-heading">Tambah Kategori Blog</h1>
        <p class="text-sm text-body mt-1">Buat kategori baru untuk mengorganisir blog</p>
    </div>

    <div class="bg-neutral-primary-soft border border-default rounded-base p-6">
        <form action="<?= url('admin/blog-categories') ?>" method="POST" x-data="categoryForm()">
            <?= csrf_field() ?>
