<?php
$service = is_array($service) ? (object)$service : $service;
?>
...
>
    ...
    >
        <div class="flex items-start mb-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-semibold text-heading mb-1">Hapus Service</h3>
                <p class="text-sm text-body">
                    Apakah Anda yakin ingin menghapus service <strong><?= htmlspecialchars($service->title ?? '') ?></strong>?
                </p>
                <p class="text-sm text-body mt-2">
                    Semua gambar dan data terkait service ini akan ikut terhapus.
                </p>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button 
                ...
                @click="deleting = true"
                :disabled="deleting"
                hx-post="<?= url('admin/services/' . ($service->id ?? '')) ?>"
            ...
            >
                ...
                <span x-text="deleting ? 'Menghapus...' : 'Hapus Service'"></span>
            </button>
        </div>
    </div>
</div>