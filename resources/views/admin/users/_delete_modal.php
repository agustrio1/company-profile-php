...
>
    ...
    >
        <div class="flex items-start mb-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-semibold text-heading mb-1">Hapus User</h3>
                <p class="text-sm text-body">
                    <?php 
                    $user = is_array($user) ? (object)$user : $user;
                    ?>
                    Apakah Anda yakin ingin menghapus user <strong><?= htmlspecialchars($user->name ?? '') ?></strong>?
                </p>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button 
                ...
                @click="deleting = true"
                :disabled="deleting"
                hx-post="<?= url('admin/users/' . ($user->id ?? '')) ?>"
