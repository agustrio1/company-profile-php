<?php
$team = is_array($team) ? (object)$team : $team;
?>
...
>
    ...
    >
        <div class="flex items-start mb-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-semibold text-heading mb-1">Hapus Team</h3>
                <p class="text-sm text-body">
                    Apakah Anda yakin ingin menghapus team <strong><?= htmlspecialchars($team->name ?? '') ?></strong>?
                </p>
                <p class="text-sm text-body mt-2">
                    Semua anggota dan data terkait team ini akan ikut terhapus.
                </p>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button 
                ...
                @click="deleting = true"
                :disabled="deleting"
                hx-post="<?= url('admin/teams/' . ($team->id ?? '')) ?>"
            ...
            >
                ...
                <span x-text="deleting ? 'Menghapus...' : 'Hapus Team'"></span>
            </button>
        </div>
    </div>
</div>