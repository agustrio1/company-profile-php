...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-heading">Manajemen Team</h1>
            <p class="text-sm text-body mt-1">Kelola tim dan anggota perusahaan</p>
        </div>
        <a href="<?= url('admin/teams/create') ?>" class="inline-flex items-center px-4 py-2.5 text-sm font-medium text-white bg-brand hover:bg-brand-strong focus:outline-none focus:ring-4 focus:ring-brand-medium rounded-base transition-colors">
    ...
    <div class="bg-neutral-primary-soft border border-default rounded-base p-4">
        <div class="relative">
            ...
            <input 
                type="text" 
                name="search"
                placeholder="Cari berdasarkan nama team..."
    ...
    <div id="teams-table" 
         hx-get="<?= url('admin/teams/table') ?>"
         hx-trigger="load, teamDeleted from:body, employeeDeleted from:body">
        <!-- Loading indicator -->
