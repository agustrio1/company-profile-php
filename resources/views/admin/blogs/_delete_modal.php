...
>
    ...
    >
        <div class="flex items-start mb-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-semibold text-heading mb-1">Hapus Blog</h3>
                <p class="text-sm text-body">
                    Apakah Anda yakin ingin menghapus blog <strong><?= htmlspecialchars($blog->title ?? '') ?></strong>?
                </p>
                <p class="text-sm text-body mt-2">
                    Semua gambar dan data terkait blog ini akan ikut terhapus.
                </p>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button 
                ...
                @click="deleting = true"
                :disabled="deleting"
                hx-post="<?= url('admin/blogs/' . ($blog->id ?? '')) ?>"
            ...
            >
                ...
                <span x-text="deleting ? 'Menghapus...' : 'Hapus Blog'"></span>
            </button>
        </div>
    </div>
</div>